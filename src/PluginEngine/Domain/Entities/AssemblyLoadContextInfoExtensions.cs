...
/// <summary>
/// Provides extension methods for <see cref="AssemblyLoadContextInfo"/> to
...
public static class AssemblyLoadContextInfoExtensions
{
	...
	/// </summary>
	/// <param name="context">The assembly load context.</param>
	/// <returns>The minutes since last activity.</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="context"/> is null.</exception>
...
""";
	...
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="context"/> or <paramref name="pattern"/> is null.</exception>
	...
	/// <summary>
	/// Gets the memory usage in a human-readable format (bytes, KB, MB, GB).
	/// </summary>
	/// <param name="context">The assembly load context.</param>
