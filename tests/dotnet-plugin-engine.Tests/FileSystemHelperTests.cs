...
/// <summary>
/// Provides unit tests for the <see cref="FileSystemHelper"/> class to verify file system operations.
/// </summary>
public sealed class FileSystemHelperTests
{
	/// <summary>
	/// Mock logger instance for testing file system operations.
	/// </summary>
	private readonly Mock<ILogger<FileSystemHelper>> _mockLogger;

	/// <summary>
	/// System under test - the FileSystemHelper instance being tested.
	/// </summary>
	private readonly FileSystemHelper _sut;

	/// <summary>
	/// Temporary test directory path used for testing.
	/// </summary>
	private readonly string _testDirectory;

	/// <summary>
	/// Initializes a new instance of the <see cref="FileSystemHelperTests"/> class.
	/// </summary>
	...
	/// <summary>
	/// Tests that EnsureDirectoryExists creates a directory when it doesn't exist.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that EnsureDirectoryExists returns true when the directory already exists.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that EnsureDirectoryExists returns false when given an invalid path.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that DiscoverPlugins returns an empty list when the directory doesn't exist.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that DiscoverPlugins returns an empty list when the directory is empty.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that DiscoverPlugins returns all DLL files in a directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that DiscoverPlugins excludes files starting with underscore.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that GetFileInfo returns file size and modified time for an existing file.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that GetFileInfo returns null for a non-existent file.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that GetFileInfo returns the correct size for a large file.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that DeleteDirectoryRecursive deletes an existing directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that DeleteDirectoryRecursive returns true for a non-existent directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that SafeCopyFile copies a file when source and destination are valid.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that SafeCopyFile returns false when the source file doesn't exist.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that SafeCopyFile returns false when destination exists and overwrite is disabled.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that SafeCopyFile overwrites the destination when overwrite is enabled.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that GetDirectorySize returns zero for an empty directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that GetDirectorySize returns the total size of all files in a directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that GetDirectorySize returns zero for a non-existent directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that CreateBackup creates a backup file with timestamp for an existing file.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that CreateBackup returns null for a non-existent file.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that IsDirectoryWritable returns true for a writable directory.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that IsDirectoryWritable returns false for a non-existent directory.
	/// </summary>
	[Fact]
